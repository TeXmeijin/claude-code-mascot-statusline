export function analyzeSpriteFrame(frame) {
...
export function formatVisualLint(lint) {
...
function buildBands(occupancy, targetCenter) {
...
function computeMirrorMismatchRatio(occupancy) {
    const height = occupancy.length;
...
function buildWarnings(overallCenterOffset, bands, mirrorMismatchRatio) {
    const warnings = [];
...
//# sourceMappingURL=visual-lint.js.map