export function analyzeCapture(image, options = {}) {
...
function analyzeBounds(image, rect, background, threshold) {
...
function findSubjectBounds(image, crop, background, threshold) {
...
function sampleBackground(image, crop) {
    const samplePoints = [
        [crop.x, crop.y],
...
function isForeground(image, x, y, background, threshold) {
...
function buildWarnings(overall, top, bottom) {
    const warnings = [];
